...
[^changes]: Yes the journal book view and zoom loupe have gone away. Change is good, deal with it <svg class="icon"><use xlink:href="#icon-deal-with-it"></use></svg>.
...
OK, back to lusting over the new **Apple Pencil** and waiting for the day Apple brings that technology to the smaller and cheaper iPads <svg class="icon"><use xlink:href="#icon-wink"></use></svg>.
