---
layout: article
title: "Mastering Mix by 53"
modified: 
categories: mastering-paper
excerpt: "Learn how to use Mix."
tags: [Paper by 53, Mix, tutorial, drawing, painting, iPad]
image:
  feature: 
  teaser: 
comments: true
...
As an avid Paper creator, sharing sketches and "ideas" has felt a bit like I was in an empty room talking to myself. Sure I could ask for feedback in the form of a 140 character Tweet or reblog on Tumblr, but the act of collaborating was missing. With the release of Mix, that void has been filled.
...
Each idea shared to Mix can be "favorited" by tapping the star button below it. Starred ideas, sketches, templates or doodles are grouped in a journal named Stars that works like any other journal you create in Paper (can move/duplicate/share/delete pages).

<figure>
  <img src="{{ site.url }}/images/mix-53-stars-journal.jpg" alt="Stars journal in Paper">
  <figcaption>Your Starred ideas can be found in the Stars journal to the far right.</figcaption>
</figure>
...
* Create/find templates to build off of. Use as a framework to jump start your creativity. 
* Sketch notes and collaborative note taking during conferences to help visualize concepts and keep a record of what was discussed.
* Post word, math, science related problems for your students to work on and then discuss their solutions by flipping through all of the remixes.
...
My approach to sketching on Paper has been to add "behind the scenes footage" whenever possible. Whether it was by recording a time lapse video to show how I created a drawing or by sharing in process screenshots on social media. With Mix there's now a clean and seamless way to expose a drawing's evolution directly in Paper.
...
<figure class="half">
  <a href="https://mix.fiftythree.com/11098-Michael-Rose/899124" target="_blank"><img src="{{ site.url }}/images/mix-53-draw-a-cat-2.jpg" alt="Draw a cat tutorial on Mix"></a>
  <a href="https://mix.fiftythree.com/11098-Michael-Rose/899124" target="_blank"><img src="{{ site.url }}/images/mix-53-draw-a-cat-3.jpg" alt="Draw a cat tutorial on Mix"></a>
  <figcaption><strong>Draw a Cat.</strong> An example of how to show process and teach at the same time.</figcaption>
</figure>

It may not be obvious at first but remixing your own ideas is a great way to chain together a series of sketches to show a progression.
...
#### Just a couple of the many ways of having fun on Mix:

* "Ask Me Anythings" question and answer but in visual form.
* "A Day in the Life." Doodles showing the events of your day.
* Coloring book themed ideas. Start with just an outline and let the community's imagination run wild with remixes.
...
<figure>
  <a href="https://mix.fiftythree.com/11098-Michael-Rose/914704"><img src="{{ site.url }}/images/mix-53-build-a-snowman.jpg" alt="Build a snowman on Mix"></a>
...
There is no rule that says you have to draw pictures with Paper and post those to Mix. Let the Write category be an example of the beauty of words in the hand’s of typographers, letterers, designers, and wordsmiths.
...
I hope this article has inspired you to check out Mix and become a part of the great community of Paper creators. If you're looking for Mix specific information and help the FiftyThree support forum is a great place to start.
