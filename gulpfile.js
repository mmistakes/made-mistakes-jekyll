...
gulp.task('assets', gulp.series(
  gulp.series('scripts', 'scripts:defer', 'styles', 'fonts', 'icons'),
  gulp.series('scripts:gzip', 'styles:gzip', 'images:lazyload', 'images:feature', 'copy:assets', 'copy:images', 'copy:icons', 'copy:files', 'copy:manifest')
));
...
// gulp.task('deploy', gulp.series('upload', 'submit:sitemap')); //TODO: submit sitemap
gulp.task('submit_sitemap', gulp.series('submit:sitemap'));
