...
Whichever way you end up choosing I suggest you drag this newly mixed off-white color to an open slot in one of your palettes... for safe keeping.
...
Now the fun begins! Select the off-white color you mixed/copied earlier and begin sketching.

<figure>
  <img src="{{ site.url }}/images/paper-53-white-sketch-layer.jpg" alt="white sketch layer">
  <figcaption>White sketch &ldquo;faux&rdquo; layer.</figcaption>
</figure>
...
In this example I used a dark gray to draw the contour lines of the face and drop in some shadows using a [cross-hatching technique]({{ site.url }}{% post_url /mastering-paper/2014-02-09-basics %}#ink-techniques). There's no need to complete the drawing at this point, you just want to establish enough contours and values to get you most of the way there. It can be disorientating to draw light on dark so take it as far as you're comfortable with and finish after the next step.
...
Now you can continue adding to page by drawing and painting on top of what remains. I think you'll find this method is so much faster than having to carefully erase or Blend away lines from an "underdrawing."
...
I think Ron is onto something and brings up a great use for the faux layer method. In one of my earlier tutorials I talked about [using grids]({{ site.url }}{% post_url /mastering-paper/2014-07-06-grid-method %}) to aid in drawing more accurately. Creating a grid in the 48/2/96 off-white would sure make things easier than having to remove all of the guidelines by hand.

<figure>
  <img src="{{ site.url }}/images/#.jpg" alt="grid template">
  <figcaption>Grid template available for free on FiftyThree's Mix service.</figcaption>
</figure>

So that's exactly what I've done with this template shared on Mix. Feel free to download, save to Paper, and remix your own variations of it.
