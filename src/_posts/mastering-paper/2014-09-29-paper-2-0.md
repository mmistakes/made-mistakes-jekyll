...
image:
  ...
  thumb: /assets/images/paper-2-0-0-th.jpg
...
<figure>
  {% include youtube id="cleK43E6M6o" %}
...
<figure>
  {% include youtube id="2BJerajpehQ" %}
...
<figure>
  <img src="{{ site.url }}/assets/images/ios-8-accessibility-zoom.jpg" alt="iOS 8 Settings app screenshot">
...
<figure>
  {% include youtube id="6_n1eWpZlV8" %}
