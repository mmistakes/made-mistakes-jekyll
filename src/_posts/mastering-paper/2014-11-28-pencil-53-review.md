...
<figure class="half">
  <a href="{{ site.url }}{% post_url 2014-10-25-erasing %}"><img src="{{ site.url }}/images/paper-53-erasing-corner.jpg" alt="erasing with the corner"></a>
  <a href="{{ site.url }}{% post_url 2014-10-25-erasing %}"><img src="{{ site.url }}/images/paper-53-erasing-wide.jpg" alt="erasing with the entire edge"></a>
