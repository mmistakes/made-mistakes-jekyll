...
<figure>
  {% include youtube id="RRYmYPf1KpY" %}
...
<figure>
  {% include youtube id="vmgQpzBOOSc" %}
...
<figure>
  {% include youtube id="ChJ3LSCOyoM" %}
...
<figure>
  {% include youtube id="rqBLBCfDjZU" %}
...
<figure>
  {% include youtube id="k3glCSQt22M" %}
...
<figure>
  {% include youtube id="O31BPEgKrXs" %}
...
<figure>
  {% include youtube id="nzfTY5rw9Q0" %}
...
<figure>
  {% include youtube id="TboRri2mOVQ" %}
...
<figure>
  {% include youtube id="fJdHAM9u4Sk" %}
...
<figure class="half">
  ...
  {% include youtube id="GdPYXERDH4M" %}
