...
{% figure caption:"Switching between modes of working is a breeze with Pencil." class:"third" %}
...
{% figure caption:"Digital strokes made using the angled edge of Pencil's tip compared against those made with compressed charcoal on traditional paper." class:"half" %}
...
{% figure caption:"Tripod grip on the left (good for writing), palm grip on the right (good for gesture drawing)." class:"half" %}
...
{% figure caption:"Check out all my [*bokeh* PaperFaces portraits](/tag/bokeh/) where I used this effect with and without Pencil." class:"third" %}
...
{% figure caption:"Use the pen tools filled with a dark color to build up the tree silhouettes." class:"half" %}
...
{% figure caption:"Some examples of underwater scenes I painted with Paper by FiftyThree using Pencil and Blend." class:"third" %}
...
{% figure caption:"Don't worry about adding too many details at this point, we're going to smudge most of the scene away in a minute..." class:"third" %}
...
{% figure caption:"By leaving the edges around the scuba diver sharp, the figure will pop-off the page as it contrasts against the soft background." class:"half" %}
...
{% figure caption:"Use quick blends for fluffy clouds and slow dragging smudges for for streaky ones." class:"half" %}
...
{% figure caption:"Give light trails a sense of motion by pulling your blend strokes slowly. Practice smudging the [aurora borealis on Mix](https://mix.fiftythree.com/11098-Michael-Rose/915375)." class:"half" %}
...
{% figure caption:"Blend the plane (or object) furthest from the foreground the most and gradually decrease that amount as you move forwards." class:"half" %}
...
{% figure caption:"Start by drawing the horizon line so you know where to place the trees and those that will be reflected below in the water. Then cover the canvas in circular blend strokes to blur everything." class:"third' %}
...
{% figure caption:"Blending shapes into glowing objects." class:"half" %}
...
{% figure caption:"Both of these paintings have been shared on Mix for you to play with and alter." class:"half" %}
...
{% figure caption:"Flames aren't the only thing you can smudge into existence. Pencil strokes can be transformed into smoke trails just as easily with slow blends." class:"half" %}
...
{% figure caption:"Blend got away from me here as I distorted the shape of the face too much and lost all of the texture from the original watercolor layers." class:"half" %}
