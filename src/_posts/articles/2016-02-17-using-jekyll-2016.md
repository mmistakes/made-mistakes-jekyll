...
**Made Mistakes** has always had a singular voice, so supporting multiple authors wasn't really on my radar. But for some of [my Jekyll themes]({{ site.url }}{% link _work/jekyll-themes.md %}) the need arose and I added support for assigning authors with a data file. 
