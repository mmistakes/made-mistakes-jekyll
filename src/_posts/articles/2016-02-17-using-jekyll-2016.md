...
{% figure caption:"(First) post layout then, (second) post layout now." class:"half" %}
...
{% figure caption:"Title/excerpt versus image/date/title/excerpt post lists." class:"half" %}
