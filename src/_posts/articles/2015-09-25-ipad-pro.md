...
{% figure caption:"My early attempts with Procreate weren't all that great. It took me some time to figure out the paint engine as it felt less organic than what I was used to with traditional media." class:"half" %}
...
{% figure caption:"Layers, and blending modes, and time lapse recording, oh my!" class:"half" %}
