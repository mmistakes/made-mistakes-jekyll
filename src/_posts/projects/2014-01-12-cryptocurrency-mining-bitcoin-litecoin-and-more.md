...
gallery_QR_codes:
  - url: "/assets/images/cryptocurrency-mining-QR-donate.png"
    image_path: "/assets/images/cryptocurrency-mining-QR-donate.png"
    alt: "QR code to transfer to Bitcoin address"
    title: "QR code to transfer to address"
  - url: "/assets/images/cryptocurrency-mining-QR-donate-0.005.png"
    image_path: "/assets/images/cryptocurrency-mining-QR-donate-0.005.png"
    alt: "QR code to donate 0.005 BTC"
    title: "QR code to donate 0.005 BTC"
---
...
{% include figure
  image_path="/assets/images/cryptocurrency-mining-Bitstamp-BTC_USD-BitcoinWisdom.png"
  caption="Bitcoin value in USD over time - from BitcoinWisdom.com"
%}
...
{% include figure
  image_path="/assets/images/cryptocurrency-mining-bitcoin-logo.png"
...
{% include gallery
  id="gallery_QR_codes"
  caption="QR code for 343m5YhZ7y78WokLVqHDFC6K2k896sWCNw with (right) and without (left) a preset amount of 0.005 BTC"
%}
...
Bitcoin is just one of many cryptocurrencies, but it is the first and most integrated of them all. Now, why is this so interesting besides potentially revolutionizing currency as we know it? From wikipedia:
...
Basically, by using your computer with an internet connection you can join these networks and get a small amount of cryptcurrency which then again can be exchanged for "real" money, like USD or euros. With the correct price for electricity, cryptocurrency and difficulty in mining you can make actual money.

{% include figure
  image_path="/assets/images/cryptocurrency-mining-litecoin-logo.png"
  caption="Litecoin logo"
%}
...
{% include figure
  image_path="/assets/images/cryptocurrency-mining-litecoin-mining.png"
  caption="Litecoin mining setup... not pretty, but it works!"
%}
...
{% include figure
  image_path="/assets/images/cryptocurrency-mining-CGMiner.jpg"
  caption="My CGMiner performance"
%}
...
{% include figure
  ...
  caption="Using the Danish winter to cool the setup when not home"
%}
